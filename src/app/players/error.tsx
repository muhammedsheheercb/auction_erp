...
export default function PlayersError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 flex flex-col items-center justify-center text-center">
      <h2 className="text-2xl font-black uppercase tracking-tighter text-red-400 mb-4">Failed to load players</h2>
      ...
      <button
        onClick={reset}
        className="px-6 py-3 bg-amber-600 text-white font-black uppercase tracking-widest text-xs rounded-full hover:bg-amber-500 transition-colors"
      >
        Try again
      </button>
    </div>
