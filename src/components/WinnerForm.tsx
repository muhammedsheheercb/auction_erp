...
import { createWinner } from "@/actions/winnerActions";
    ...
    >
      ...
      <div className="p-6 md:p-8 space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="btn-primary w-full py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.25em] active:scale-95 shadow-2xl shadow-amber-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? "Uploading..." : "Add to Hall of Fame"}
        </button>
      </div>
    </form>
  );
